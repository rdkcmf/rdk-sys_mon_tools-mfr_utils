...
if [ "x$RDK_PLATFORM_SOC" == "xintel" ]; then
    ...
    export MFR_DIR_PATH="$RDK_PROJECT_ROOT_PATH/mfrlibs"
    export MFR_LIB_NAME="-L${RDK_FSROOT_PATH}/lib -DUSE_PACE_MFR -lPaceDsgIf -lPaceDiagApi -lPaceMfrApi -lPaceEcmApi -lPaceTempControl -lPacePosixApi -lflash_appdata -lPaceNvramApi -lidl_i2c -lnand_config -lmfh -lhtx_dsg -ldsg_rpc_h2cm -lismd_clock -lismd_demux -lismd_core -lismd_audio -lsven -lpal -lplatform_config -lismdmessage -lsec -lmspod -lmspod_pal -lfwloader -lgdl -lpace_spi_drv "
    ...
    export MFR_DIR_PATH="$WORK_DIR/svn/sdk/src/mfrlibs"
